...
function changeTheme() {
    const themes = ["theme-purple","theme-jade", "theme-ocean"];
    themeNum += 1;
...
function defaultTheme() {
    ...
    document.getElementById("title").classList.remove("rainbowAnim");
...
function rainbow() {
    document.getElementById("body").classList.toggle("rainbowAnim");
}